...
namespace addresses
{
	...
	//inline void(FASTCALL* CBaseEntity_EmitSoundFilter)(CBasePlayerController* player);
}
...
namespace sigs
{
	...
	//DECLARE_SIG(CBaseEntity_EmitSoundFilter, "\x48\x89\x5C\x24\x08\x48\x89\x74\x24\x18\x57\x48\x83\xEC\x30\x48\x8B\xF2")
	//DECLARE_SIG(CBaseEntity_EmitSoundParams, "\x48\x8B\xC4\x48\x89\x58\x10\x48\x89\x70\x18\x55\x57\x41\x56\x48\x8D\xA8\x08\xFF\xFF\xFF")
