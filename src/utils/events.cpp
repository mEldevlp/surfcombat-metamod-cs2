...
{
	utils::PrintAlertAll("\5[EVENT] player_spawn");
}

GAME_EVENT_F(round_prestart)
{
	utils::PrintAlertAll("\5[EVENT] round_prestart");
}

GAME_EVENT_F(player_team)
{
	utils::PrintAlertAll("\5[EVENT] player_team");
}

GAME_EVENT_F(player_hurt)
{
	utils::PrintAlertAll("\5[EVENT] player_hurt");
}

GAME_EVENT_F(round_start)
{
	utils::PrintAlertAll("\5[EVENT] round_start");
}

GAME_EVENT_F(round_end)
{
	utils::PrintAlertAll("\5[EVENT] round_end");
}